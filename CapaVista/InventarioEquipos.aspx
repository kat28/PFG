<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPagePrincipal.master" AutoEventWireup="true" CodeFile="InventarioEquipos.aspx.cs" Inherits="InventarioEquipos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container mx-auto">
        ...
        <div class="col-lg-12">
            <div class="col-lg-12">
                <h3 class="text-center">Inventario Equipos</h3>
        ...
        <div class="col-lg-12 form-group" runat="server">
            <div class="col-lg-12">
                <h4 class="text-left text-success font-weight-bold">Lista equipos</h4>
                <hr />
            </div>
            ...
            <div class="table-responsive text-wrap" runat="server">
                ...
                <asp:GridView ID="GridView1" runat="server" HorizontalAlign="Center"
                    ...
                    AutoGenerateColumns="False" DataKeyNames="IdActivo" DataSourceID="SqlDataSourceEquipos"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Grupo" HeaderStyle-CssClass="text-center bg-info">
                            <ItemTemplate>
                                <asp:Label ID="lbl_Descripcion1" runat="server" Text='<%#Eval("Descripcion")%>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:Label ID="lbl_Descripcion" Visible="false" runat="server" Text='<%#Eval("Descripcion")%>'></asp:Label>
                                <asp:DropDownList ID="ddl_Familia"  runat="server" DataSourceID="SqlDataSourceFamilia" DataTextField="Descripcion" DataValueField="CodTipo">             
                                </asp:DropDownList>
                            </EditItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Unidades" HeaderStyle-CssClass="text-center bg-info">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txt_Cantidad" runat="server" type="number" Text='<%#Eval("Cantidad")%>'></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderStyle-CssClass="text-center bg-info" ItemStyle-CssClass="text-center" HeaderText="Costo Unitario" SortExpression="ValorOriginal">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderStyle-CssClass="text-center bg-info" ItemStyle-CssClass="text-center" HeaderText="Estado" SortExpression="CodEstado">
                            ...
                            <EditItemTemplate>
                                <asp:DropDownList ID="ddl_Estado" runat="server" DataSourceID="SqlDataSourceEstado" DataTextField="Descripcion" DataValueField="CodTipo"></asp:DropDownList>
                            </EditItemTemplate>
                            <HeaderStyle CssClass="text-center bg-info"></HeaderStyle>
                            <ItemStyle CssClass="text-center"></ItemStyle>
                        </asp:TemplateField>
                ...
                <asp:SqlDataSource ID="SqlDataSourceEquipos" runat="server" ConnectionString="<%$ ConnectionStrings:proyConnectionString %>" SelectCommand="sp_ObtenerInventarioEquipos" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
