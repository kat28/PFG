<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPagePrincipal.master" AutoEventWireup="true" CodeFile="ReportePlanilla.aspx.cs" Inherits="Reportes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container mx-auto">
        <%--Titulo--%>
        <div class="col-lg-12">
            <h3 class="text-center">Reporte Planilla</h3>
            <hr />
            <br />
        </div>
        ...
        <div class="form-inline">
            ...
            <div class="form-group ml-4">
                <asp:HyperLink ID="HyperLink2" runat="server" class="btn btn-warning bg-warning  btn-xs mb-2 text-dark" NavigateUrl="GenerarPlanilla.aspx" Text="Regresar"></asp:HyperLink>
            </div>
