<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPagePrincipal.master" AutoEventWireup="true" CodeFile="Reporte3.aspx.cs" Inherits="Reportes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container mx-auto">
        ...
        <div id="div1">
            ...
            <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" SelectMethod="obtenerPacienteG" TypeName="CapaNegocio.PacienteN"></asp:ObjectDataSource>
